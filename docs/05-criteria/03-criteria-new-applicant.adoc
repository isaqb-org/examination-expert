...
|Praxiserfahrung
|Bewerber:innen können mindestens 7 Jahre Berufserfahrung in der Rolle als Softwarearchitekt:innen in komplexen Softwareprojekten vorweisen. Dabei sind insbesondere Erfahrungen in der system-, domänen- oder organisationsübergreifende Architekturarbeit notwendig.
...
Auch Koryphäen müssen in Themenarbeitsgruppen mitarbeiten. Ohne Arbeit an einem Thema erhält niemand das EL-Zertifikat.
====
