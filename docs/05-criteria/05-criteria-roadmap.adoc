...
| Ziel, Mission
| Muss
| - Sind Ziele und Mission der Themenarbeitsgruppe verständlich beschrieben?

| Themenarbeitsgruppe
| Muss
| - Nur bei Arbeit in einer Themenarbeitsgruppe: Sind die Kontaktdaten aller Mitglieder der Themenarbeitsgruppe angeführt?
...
- Wird versucht, die Ergebnisse bei mindestens einer Konferenz zu präsentieren?
- Wird versucht, die Ergebnisse in zumindest einer Fachzeitschrift zu publizieren?
...
| Topic working group
| Essential
| - Only for topic working groups: Are the contact details of all members of the topic working group stated?
...
- Is there an attempt to present the results at at least one conference?
- Is there an attempt to publish the results in at least one trade publication?
