...
include::01-criteria-accreditation.adoc[{include_configuration}]
...
include::09-criteria-verbal-exam.adoc[{include_configuration}]

<<<

include::10-criteria-examiner.adoc[{include_configuration}]
