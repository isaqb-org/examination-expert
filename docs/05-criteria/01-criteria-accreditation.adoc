// tag::DE[]
==== Trainingsanbieter
Trainingsanbieter müssen nachfolgende Kriterien erfüllen, damit sie von iSAQB die Akkreditierung bekommen:
...
|Themenmoderator:in
|Der Trainingsanbieter muss mindestens eine:n erfolgreich zertifizierte:n Themenmoderator:in vorweisen können.
|Die Akkreditierung einer Themenmoderatorin/eines Themenmoderators ist abgeschlossen.
|===


==== Themenmoderator:innen
Ein akkreditierter Trainingsanbieter stellt einer Themenarbeitsgruppe eine:n akkreditierte:n Themenmoderator:in zu Verfügung.
