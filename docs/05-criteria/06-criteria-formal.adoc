...
| Artikel
| Muss
| Hat der Artikel die folgende Struktur und den folgenden Inhalt?
...
| Muss
| Die Ergebnisse müssen mit einer Versionshistorie abgegeben werden, damit die Prüfer:innen nachvollziehen können, dass die Ergebnisse tatsächlich von Themenbearbeiter:innen erarbeitet wurden und nicht durch künstliche Intelligenz entstanden sind.
