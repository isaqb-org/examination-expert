...
==== Formelle Kriterien für Ergebnisse

[cols="<3,<1,<7a"]
|===
| Ergebnis | Pflicht | Kriterien

| Alle
| Muss
| Ursprung der Inhalte: 

* Wurden die Inhalte eigenständig verfasst?
* Wurden alle verwendeten Quellen und Hilfsmittel vollständig angegeben?

Künstliche Intelligenz:

* Wurden die Abschnitte markiert, die mit generativer Künstlicher Intelligenz erzeugt wurden?
* Wurde die Kommunikation mit einer Künstlichen Intelligenz archiviert und den Ergebnissen beigelegt?


| Artikel
| Muss
| Hat der Artikel folgende Struktur und folgenden Inhalt?
...
... Wird behandelt, welche Auswirkungen die Erkenntnisse auf die Praxis haben?
. Zusammenfassung
[loweralpha]
...
. Interessenkonflikte
.. Werden Interessenkonflikte angeführt?
. Literaturliste
.. Ist die verwendete Literatur aufgelistet?
.. Wird korrekt zitiert?

| Weiteres Ergebnis
| Muss
| - Erfüllen Form und Inhalt den Zweck des Ergebnisses (z.{nbsp}B. ein neues Muster: Kontext, Problem, Lösung)?
...
| Muss
| Die Ergebnisse müssen versioniert abgegeben werden, damit die Prüfer:innen nachvollziehen können, dass sie tatsächlich von den Themenbearbeiter:innen erarbeitet und nicht durch künstliche Intelligenz generiert wurden.
...
==== Formal Criteria for Results

[cols="<3,<2,<7a"]
|===
| Result | Requirement | Criterion

| All
| Essential
| Origin of Content:

* Was the content written independently?
* Were all sources and tools used fully cited?

Artificial Intelligence

* Were sections generated using generative artificial intelligence marked?
* Was the interaction with the artificial intelligence archived and included with the results?
...
... Is there a description of the methods used to answer the  research question?
[loweralpha]
.. Results
[lowerroman]
...
. Summary
[loweralpha]
.. Is there a brief summary of all the research questions and their answers?
...
. Bibliography
[loweralpha]
.. Is there a list of all the literature used?
...
| Versioned results
| Essential
| The results must be submitted with a version history so that the examiners can verify that the results were actually developed by the topic workers and not generated by artificial intelligence.
