...
Possible additional costs, such as travel expenses within the scope of the collaboration or extra costs due to rework or objections, are not included and are to be borne by the topic working group itself.
