...
The topic working group chooses a training provider and informs the certification body about the selection. iSAQB publishes a list of accredited training providers.
