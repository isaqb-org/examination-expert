...
Die Themenarbeitsgruppe kommt zu Symposien zusammen, wo sie sich gemeinsam abstimmen und Aufgaben aus der Roadmap erarbeiten.
...
The topic working group brings together its experience on the selected topic, consolidates it, and derives new insights from it. The necessary work includes the collection of data, literature research, or writing. It is recommended that topic working groups publish their results at conferences or in professional journals. iSAQB will support and promote the publications.
