...
Das Zertifikat wird für die Sparte und das Thema ausgestellt. Die Person darf sich als iSAQB-zertifizierte(r) Expert:in für die Sparte bezeichnen.
...
Geben die Prüfer:innen dem Einspruch statt, kann der Prüfling erneut ein Prüfungsgespräch mit den neuen Prüfer:innen durchführen. Dafür hebt der Zertifizierer eine Gebühr von 1500 € zzgl. MwSt. ein.
...
The certificate is issued for the area and the topic. The person may refer to themselves as an iSAQB-certified expert in the field.
