...
Wenn die Prüfer:innen feststellen, dass die Ergebnisse den Kriterien nicht entsprechen, kann die Themenarbeitsgruppe einmalig nachbessern. Es steht dem Zertifizierer frei, der Themenarbeitsgruppe die Zusatzkosten für die Prüfer in Rechnung zu stellen.
...
If the examiner finds out that the results don't meet the criteria, the topic working group can improve the results once and submit them again to the certification body. The certification body is free to charge for the extra effort.
