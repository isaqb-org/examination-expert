...
2. Zwei Prüfer:innen bewerten die Ergebnisse der Themenarbeitsgruppe inhaltlich. Die Themenarbeitsgruppe kann einmalig nachbessern. Nur wenn die Prüfer:innen die Ergebnisse der Themenarbeitsgruppe positiv bewerten, dürfen die Mitglieder der Themenarbeitsgruppe am individuellen Prüfungsgespräch teilnehmen.
